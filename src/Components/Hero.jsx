...
function Hero() {
  return (
    <div className="flex items-center justify-center w-full">
      <div className="w-full max-w-[1200px] h-[565px] gap-1 grid grid-cols-3 md:grid-cols-2 sm:grid-cols-2 sm:h-[320px]">
        ...
        {/* Third block */}
        <div className="flex flex-col mb-8 hover:shadow-lg md:hidden sm:hidden ">
          <div><img src={H7} className="w-full h-[439px] sm:h-[200px]" alt="Product" /></div>
